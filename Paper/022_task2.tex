...
\item
When all persons has been considered as couple of the current \code{fixedPerson}, the \code{nextPerson} rule in Figure~\ref{fig:nextPerson}, takes the \code{peopleDealtWith} as new \code{people} set. 
\end{itemize}
