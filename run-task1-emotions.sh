...
echo " Task 1: N = 10";
echo "   loading..."
maude2.4 -no-banner MaudeExecution/Task1/loadAllFilesN10.maude > MaudeExecution/Task1/outputModel/out-n10.xmi.maude
echo " Done!"
echo " Starting parsing..."
python parse_output.py -i MaudeExecution/Task1/outputModel/out-n10.xmi.maude -o MaudeExecution/Task1/outputModel/out-n10-parsed.xmi.maude --verbose
echo " Success!"
